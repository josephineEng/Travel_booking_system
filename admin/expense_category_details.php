...
<p>
<a href="operations/expense_category.php?id=<?php echo $_GET['id']; ?>" class="button button--success" data-for="js_success-popup">Yes</a>
...
try {
    ...
    echo "Error: " . $e->getMessage();
        ...
        <td>
            <a href="expense_category_details.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash fa-2x" data-toggle="tooltip" title="Delete"></i></a>

        <a href="update_expense_category.php?id=<?php echo $value['id']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil fa-2x" data-toggle="tooltip" title="Edit"></i></a><br>
      </td>   
