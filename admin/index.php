...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                  <marquee scrollamount=4><b>Software Tour 3rd September 2022.</b></marquee>
                <div class="row">
                    <div class="col-md-3">
 ...
 $xyz = $stmt3->setFetchMode(PDO::FETCH_ASSOC);
      ...
      $payment=$stmt3->fetch(PDO::FETCH_ASSOC);
       ...
       $stmt6 = $conn->prepare("SELECT SUM(insert_amount) as amt from payment where booking_id='".$booking['id']."'"); 
                ...
                <footer class="footer text-center" ><strong>All Rights Reserved | Elago Technologies Ltd</strong>
            <?php
